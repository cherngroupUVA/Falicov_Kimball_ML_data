...
path = "/scratch/sz8ea/FK/model/new_R10/model/P2_A/"

#%%
df_train = pd.read_csv("/scratch/sz8ea/FK/model/new_R10/relax/T0.05/job2/P2_A/input1.txt",sep='\t', header=None)
df_train_y = pd.read_csv("/scratch/sz8ea/FK/model/new_R10/relax/T0.05/job2/P2_A/output1.txt",sep='\t', header=None)

for i in range(1,5):
    for j in range(1,8):
        data_name_in = "/scratch/sz8ea/FK/model/new_R10/job"+str(i)+"/P2_A/"+"input"+str(j)+".txt" 
        data_name_out = "/scratch/sz8ea/FK/model/new_R10/job"+str(i)+"/P2_A/"+"output"+str(j)+".txt"
        #print(data_name_in)
        #print(data_name_out)       
...
for i in range(2,3):
    for j in range(2,101):
        data_name_in = "/scratch/sz8ea/FK/model/new_R10/relax/T0.05/job"+str(i)+"/P2_A/"+"input"+str(j)+".txt" 
        data_name_out = "/scratch/sz8ea/FK/model/new_R10/relax/T0.05/job"+str(i)+"/P2_A/"+"output"+str(j)+".txt"
        #print(data_name_in)
        #print(data_name_out)       
        in_data = pd.read_csv(data_name_in,sep='\t', header=None)
        out_data = pd.read_csv(data_name_out,sep='\t', header=None)
