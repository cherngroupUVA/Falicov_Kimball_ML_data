...
path = "/scratch/sz8ea/FK/model/new_R10/model/P4/"

#%%
df_train = pd.read_csv("/scratch/sz8ea/FK/model/new_R10/relax/T0.05/job2/P4/input1.txt",sep='\t', header=None)
df_train_y = pd.read_csv("/scratch/sz8ea/FK/model/new_R10/relax/T0.05/job2/P4/output1.txt",sep='\t', header=None)

for i in range(1,7):
    for j in range(1,11):
        data_name_in = "/scratch/sz8ea/FK/model/new_R10/job"+str(i)+"/P4/"+"input"+str(j)+".txt" 
        data_name_out = "/scratch/sz8ea/FK/model/new_R10/job"+str(i)+"/P4/"+"output"+str(j)+".txt"
        #print(data_name_in)
        #print(data_name_out)       
...
for i in range(2,3):
    for j in range(2,22):
        data_name_in = "/scratch/sz8ea/FK/model/new_R10/relax/T0.05/job"+str(i)+"/P4/"+"input"+str(j)+".txt" 
        data_name_out = "/scratch/sz8ea/FK/model/new_R10/relax/T0.05/job"+str(i)+"/P4/"+"output"+str(j)+".txt"
        #print(data_name_in)
        #print(data_name_out)       
        in_data = pd.read_csv(data_name_in,sep='\t', header=None)
        out_data = pd.read_csv(data_name_out,sep='\t', header=None)
