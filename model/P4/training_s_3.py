...
df_train_matrix_y = df_train_matrix_y[:,3]
...
#%%
import joblib
joblib.dump(scaler_x, path+'X_scaler_3.pkl')
joblib.dump(scaler_y, path+'Y_scaler_3.pkl')
#%%
...
net = net.double()
if os.access(path+"model_3.pt",os.R_OK):
    net.load_state_dict(torch.load(path + "model_3.pt"))
lrspeed=1000
lr=1/lrspeed
...
#%%
torch.save(net.state_dict(),path + "model_3.pt")
#%%
