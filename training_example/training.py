...
#%%
df_train = pd.read_csv("random_input.txt",sep='\t', header=None)
df_train_y = pd.read_csv("random_output.txt",sep='\t', header=None)
data_name_in = "ed_input".txt" 
data_name_out = "ed_output.txt"
